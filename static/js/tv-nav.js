  ...
  class TVRemoteNavigator {
    ...
    spatialSearch(dx, dy) {
      const focusables = Array.from(document.querySelectorAll(
        '.movie-card:not([style*="display: none"]), .btn-netflix, .nav-link, .server-btn, .action-circle-btn, .modal-close-btn, .xtream-chip, .xtream-search-input, .xtream-search-clear, .telerealite-chip, .telerealite-search-input, .telerealite-search-clear'
      ));
